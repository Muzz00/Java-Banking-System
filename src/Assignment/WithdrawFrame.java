...
public class WithdrawFrame {
	...
	private void initialize() {
		...
		btn50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (workingFile.equals("Credit") || newBalance >= 0) {
					...
					JOptionPane.showMessageDialog(null, "You cannot overdraft on your savings Account");
				}
		...
		lblQuickDeposit = new JLabel("Quick Withdraw");
		lblQuickDeposit.setBounds(34, 115, 121, 14);
		frame.getContentPane().add(lblQuickDeposit);

		lblCustomDeposit = new JLabel("Custom Withdraw");
		lblCustomDeposit.setBounds(34, 185, 121, 14);
	...
	private static void editRecord(String CustNum, String Balance) {
		String tempFile = "./src/Assignment/temp.txt";
		...
		try {
			...
			f1.delete();
			File f2 = new File("./src/Assignment/temp.txt");
